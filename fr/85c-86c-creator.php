...
//       echo $filename;
  ...
  $onti_calctype = isset($_POST["onti_calctype"]) ? $_POST["onti_calctype"] : '85';
  ...
  ?>
    ...
    ?>
           ...
           <a href="85c-86c-encoder.php?type=85c&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/83c.gif"> Enregistrer en <? echo $onti_calctype == '85' ? '85C' : '86C';?></a>
           &nbsp;&nbsp;&nbsp;
           <a href="85c-86c-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Enregistrer en TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="85c-86c-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Enregistrer en TXT sans les informations d'entête</a>
    <?
         }
    ?>
    <form action="85c-86c-creator.php" enctype="multipart/form-data" method="post">
            ...
            <tr>
              ...
              <td>
                <select name="onti_calctype">
                  <option value="85" <? echo $onti_calctype == '85' ? 'selected' : '' ?>>TI-85</option>
                  <option value="86" <? echo $onti_calctype == '86' ? 'selected' : '' ?>>TI-86</option>
                </select>
              </td>
            </tr>
            <tr>
