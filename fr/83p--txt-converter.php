   ...
   if ( (!isset($_FILES['userfile'])) || (!move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadDir . $ffilename)))
     {
       ...
       echo '<form enctype="multipart/form-data" action="83p--txt-converter.php" method="post">';
       echo '<input type="hidden" name="MAX_FILE_SIZE" value="5000000" />';
       echo 'Ouvrir un programme TI (83p): <input name="userfile" type="file" /> <input type="submit" value="Ouvrir">';
       echo '</form>';  
       include "bottom.php";
       die();
     }
...
//      echo $Bytes[$i];
  ...
  echo '<div style="float: left;"><a href="get8Xtxt.php"><img src="./images/extensions/txt.png"> Enregistrer en TXT</a></div>';
