<?
         ...
         if ($encode_type != "txtnoheader")
           {
             ...
             $str .= "Modèle de calculette:: ".$CaltocheName;
  ...
  else if ($encode_type == "89s")
    {
      $final_filename = "$onti_folder"."-"."$onti_filename".".tizw.89s";
      $text = $onti_text;
...
//        $text = ' '.$text;
      ...
      $entete[87] = floor(($file_89_length-1) % 256);
      $a += floor(($file_89_length-1) % 256);
...
//      $entete[89] = 1;
      ...
      $checksum = ($checksum + $a + 0x2D) % 65536;
