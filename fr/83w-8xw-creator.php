...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="83w-8xw-encoder.php?type=8xw&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/83t.gif"> Enregistrer en <? echo $onti_calctype == '83' ? '83W' : '8XW';?></a>
           &nbsp;&nbsp;&nbsp;
           <a href="83w-8xw-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Enregistrer en TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="83w-8xw-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Enregistrer en TXT sans les informations d'entête</a>
    <?
         }
    ?>
    <form action="83w-8xw-creator.php" enctype="multipart/form-data" method="post">
