...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           &nbsp;&nbsp;&nbsp;
           <a href="83l-8xl-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Enregistrer en TXT sans les informations d'entête</a>
    <?
         }
    ?>
        ...
        <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <input type="radio" name="onti_listformat" value="COMPLEX" <? echo $onti_listformat == "COMPLEX" ? 'checked' : '' ?>> Complèxe
              </td>
            </tr>
        </tbody>
      </table>
