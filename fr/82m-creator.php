...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="82m-encoder.php?type=82m&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/89m.gif"> Enregistrer en 82M</a>
           &nbsp;&nbsp;&nbsp;
           <a href="82m-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Enregistrer en TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="82m-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Enregistrer en TXT sans les informations d'entête</a>
    <?
         }
    ?>
    <form action="82m-creator.php" enctype="multipart/form-data" method="post">
      ...
      <h2>Contenu du fichier</h2>
        Taille de la matrice: <input type="text" name="listcount" value="<? echo $listcount; ?>"> rangées et <input type="text" name="listcount2" value="<? echo $listcount2; ?>"> colonnes. 
        <br><br>
        <table>
          <?
             for ($j=0; $j<$listcount; $j++)
