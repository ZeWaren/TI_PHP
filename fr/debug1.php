...
/*    for ($i=0; $i<strlen($contents); $i++)
  ...
  echo '<h1>Information sur le fichier</h1>';
  echo '<br><b>Entête du fichier:</b><ul>';
  echo '<li>Modèle: '.$CaltocheName.'</li>';
  echo '<li>Dossier: "'.$TIFolder.'"</li>';
  echo '<li>Nom: "'.$TIName.'"</li>';
  echo '<li>Commentaire: "'.$TIComment.'"</li>';
  echo '<li>Stockage: '.$TIStoreType.'</li>';
  echo '</ul>';

  echo '<h1>Contenu du fichier</h1><br>';
