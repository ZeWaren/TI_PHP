...
<?
 ...
 $ffilename=session_id();
   if ( (!isset($_FILES['userfile'])) || (!move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadDir . $ffilename)))
     {
       ...
       echo '<form enctype="multipart/form-data" action="83m-8xm--txt-converter.php" method="post">';
       echo '<input type="hidden" name="MAX_FILE_SIZE" value="5000000" />';
       echo 'Ouvrir une matrice TI (83m, 8xm): <input name="userfile" type="file" /> <input type="submit" value="Ouvrir">';
       echo '</form>';  
       include "bottom.php";
       die();
     }
  ...
  if ($contents == "**TI83F*")
    {
          ...
          if (ord($contents) != 0x02)
            {
               echo 'File Problem - Doesn\'t seem to be a Matrix File<br>';
               echo '<a href="index.php">Retour au menu principal</a>';
               echo '<h2>Ouvrir un fichier</h2>';
               echo '<form enctype="multipart/form-data" action="83m-8xm--txt-converter.php" method="post">';
               echo '<input type="hidden" name="MAX_FILE_SIZE" value="5000000" />';
                ...
                for ($i=0; $i<$itemcount; $i++)
                  {
                    ...
                    $text .= '<td>'.$sign.$numberstring."</td>";
                    $text2 .= $sign.$numberstring.', ';
                  }
                $text .= "</tr>";
                $text2 .= "\r\n";
              }
  ...
  echo '<li>Dimensions de la matrice: <font color="DimGray">'.$itemcount.' x '.$itemcount2.'</font></li>';
  echo '</ul>';

  echo '<h2>Contenu du fichier</h2>';

  echo '<div style="float: left;"><a href="83m-8xm-file-as-text-file.php"><img src="./images/extensions/txt.png"> Enregistrer en TXT</a></div>';
  echo '<div style="float: left;">&nbsp;&nbsp;&nbsp;&nbsp;<a href="83m-8xm-file-as-text-file.php?noheader=true"><img src="./images/extensions/txt.png"> Enregistrer en TXT sans les informations d\'entête</a></div>';
