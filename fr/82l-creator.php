...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="82l-encoder.php?type=82l&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/89l.gif"> Enregistrer en 82L</a>
           &nbsp;&nbsp;&nbsp;
           <a href="82l-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Enregistrer en TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="82l-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Enregistrer en TXT sans les informations d'entête</a>
    <?
         }
    ?>
    <form action="82l-creator.php" enctype="multipart/form-data" method="post">
      ...
      <h2>Contenu du fichier</h2>
        Nombre d'éléments: <input type="text" name="listcount" value="<? echo $listcount; ?>">
        <br><br>
        <table>
          <?
