...
<?
 ...
 $ffilename=session_id();
   if ( (!isset($_FILES['userfile'])) || (!move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadDir . $ffilename)))
     {
       ...
       echo '<form enctype="multipart/form-data" action="89t-92t-9xt-v2t--txt-converter.php" method="post">';
  ...
  echo '<div style="float: left;"><a href="gettxt.php"><img src="./images/extensions/txt.png"> Enregistrer en TXT</a> &nbsp;&nbsp; <a href="gettxt.php?removetags=1"><img src="./images/extensions/txt.png"> Enregistrer en TXT without any "&amp;" or "&" tags</a></div>';
