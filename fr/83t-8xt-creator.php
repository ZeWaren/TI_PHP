...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="83t-8xt-encoder.php?type=8xt&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/83c.gif"> Enregistrer en <? echo $onti_calctype == '83' ? '83T' : '8XT';?></a>
           &nbsp;&nbsp;&nbsp;
           <a href="83t-8xt-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Enregistrer en TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="83t-8xt-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Enregistrer en TXT sans les informations d'entête</a>
    <?
         }
    ?>
    <form action="83t-8xt-creator.php" enctype="multipart/form-data" method="post">
