   ...
   if ( (!isset($_FILES['userfile'])) || (!move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadDir . $ffilename)))
     {
       ...
       echo 'Ouvrir un fichier texte TI (89t, 92t, 9xt, v2t): <input name="userfile" type="file" /> <input type="submit" value="Ouvrir">';
       echo '</form>';
       include "bottom.php";
       die();
     }
...
//        if (($i >= 1) && !(ord($contents[$i-1])==13))
  ...
  echo '<br clear="all"><h2>Contenu du fichier</h2>';
  echo '<div style="float: left">';
  echo '<a href="./htmlconverted/'.$ffilename.'.html"><img src="./images/extensions/html.png"> Enregistrer en HTML</a>';
  echo '<br><br>';
  ?>
    </div>
    <div style="float: right;">
      <div style="padding: 3px;">
        <font color="#663300">Vecteurs (#V)</font><br>
        <font color="darkgreen">Images (&P)</font><br>
        <font color="darkblue">Formules (&E)</font><br>
      </div>
    </div><br clear="all">
  <?  
...
/*  echo '<h1>File Hexa</h1><br>';
  ...
  echo '</tr></table>';*/
  fclose($handle);
  echo '<br><a href="index.php">Retour au menu principal</a>';
?>
