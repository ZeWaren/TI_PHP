...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="83c-8xc-encoder.php?type=8xc&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/83c.gif"> Enregistrer en <? echo $onti_calctype == '83' ? '83C' : '8XC';?></a>
           &nbsp;&nbsp;&nbsp;
           <a href="83c-8xc-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Enregistrer en TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="83c-8xc-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Enregistrer en TXT sans les informations d'entête</a>
    <?
         }
    ?>
