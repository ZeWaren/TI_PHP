...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="getencodedtextfile.php?type=89t"><img src="./images/extensions/89t.png"> Enregistrer en 89T / 92T</a>
           &nbsp;&nbsp;&nbsp;
           <a href="getencodedtextfile.php?type=txt"><img src="./images/extensions/txt.png"> Enregistrer en TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="getencodedtextfile.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Enregistrer en TXT sans les informations d'entête</a>
    <?
         }
    ?>
