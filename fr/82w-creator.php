...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="82w-encoder.php?type=82w&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/83t.gif"> Enregistrer en 82W</a>
           &nbsp;&nbsp;&nbsp;
           <a href="82w-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Enregistrer en TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="82w-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Enregistrer en TXT sans les informations d'entête</a>
    <?
         }
    ?>
