...
<?
 ...
 $ffilename=session_id();
  ...
  echo '<div style="float: left;">&nbsp;&nbsp;&nbsp;&nbsp;<a href="83c-8xc-file-as-text-file.php?noheader=true"><img src="./images/extensions/txt.png"> Enregistrer en TXT sans les informations d\'entête</a></div>';
