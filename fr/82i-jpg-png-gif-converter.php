   ...
   if ( (!isset($_FILES['userfile'])) || (!move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadDir . $ffilename)))
     {
       ...
       echo 'Ouvrir un fichier image TI (82i): <input name="userfile" type="file" /> <input type="submit" value="Ouvrir">';
       echo '</form>';  
       include "bottom.php";
       die();
     }
...
//               $k += $widthextension-$width-1;  
  ...
  echo '<a href="82i-file-as-image-file.php?type=jpeg"><img src="./images/extensions/jpg.png"> Enregistrer en JPEG</a> &nbsp;&nbsp;';
  echo '<a href="82i-file-as-image-file.php?type=png"><img src="./images/extensions/png.png"> Enregistrer en PNG</a>&nbsp;&nbsp;';
  echo '<a href="82i-file-as-image-file.php?type=gif"><img src="./images/extensions/jpg.png"> Enregistrer en GIF</a><br><br>';
