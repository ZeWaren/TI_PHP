...
<?
 ...
 $ffilename=session_id();
   if ( (!isset($_FILES['userfile'])) || (!move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadDir . $ffilename)))
     {
       ...
       echo 'Open a TI Complex File (85c, 86c): <input name="userfile" type="file" /> <input type="submit" value="Open">';
       echo '</form>';  
       include "bottom.php";
       die();
     }
  ...
  echo '<div style="float: left;"><a href="85c-86c-file-as-text-file.php"><img src="./images/extensions/txt.png"> Save as TXT</a></div>';
  echo '<div style="float: left;">&nbsp;&nbsp;&nbsp;&nbsp;<a href="85c-86c-file-as-text-file.php?noheader=true"><img src="./images/extensions/txt.png"> Save as TXT without any header information</a></div>';
