...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="85c-86c-encoder.php?type=85c&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/83c.gif"> Save as <? echo $onti_calctype == '85' ? '85C' : '86C';?></a>
           &nbsp;&nbsp;&nbsp;
           <a href="85c-86c-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Save as TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="85c-86c-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Save as TXT without header information</a>
    <?
         }
    ?>
