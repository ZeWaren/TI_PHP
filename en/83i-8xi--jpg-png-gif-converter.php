   ...
   if ( (!isset($_FILES['userfile'])) || (!move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadDir . $ffilename)))
     {
       ...
       echo 'Open a TI Image File (83i, 8xi): <input name="userfile" type="file" /> <input type="submit" value="Open">';
       echo '</form>';  
       include "bottom.php";
       die();
     }
...
//               $k += $widthextension-$width-1;  
  ...
  echo '<a href="83i-8xi-file-as-image-file.php?type=jpeg"><img src="./images/extensions/jpg.png"> Save as JPEG</a> &nbsp;&nbsp;';
  echo '<a href="83i-8xi-file-as-image-file.php?type=png"><img src="./images/extensions/png.png"> Save as PNG</a>&nbsp;&nbsp;';
  echo '<a href="83i-8xi-file-as-image-file.php?type=gif"><img src="./images/extensions/jpg.png"> Save as GIF</a><br><br>';
