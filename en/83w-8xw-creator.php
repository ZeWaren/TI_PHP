...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="83w-8xw-encoder.php?type=8xw&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/83t.gif"> Save as <? echo $onti_calctype == '83' ? '83W' : '8XW';?></a>
           &nbsp;&nbsp;&nbsp;
           <a href="83w-8xw-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Save as TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="83w-8xw-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Save as TXT without header information</a>
    <?
         }
    ?>
