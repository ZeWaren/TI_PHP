   ...
   if ( (!isset($_FILES['userfile'])) || (!move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadDir . $ffilename)))
     {
       ...
       echo 'Open a TI Program File (83p): <input name="userfile" type="file" /> <input type="submit" value="Open">';
       echo '</form>';  
       include "bottom.php";
       die();
     }
...
//      echo $Bytes[$i];
  ...
  echo '<div style="float: left;"><a href="get8Xtxt.php"><img src="./images/extensions/txt.png"> Save as TXT</a></div>';
