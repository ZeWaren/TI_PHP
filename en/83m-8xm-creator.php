...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="83m-8xm-encoder.php?type=8xm&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/89m.gif"> Save as <? echo $onti_calctype == '83' ? '83M' : '8XM';?></a>
           &nbsp;&nbsp;&nbsp;
           <a href="83m-8xm-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Save as TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="83m-8xm-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Save as TXT without header information</a>
    <?
         }
    ?>
