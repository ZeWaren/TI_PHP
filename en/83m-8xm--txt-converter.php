...
<?
 ...
 $ffilename=session_id();
   if ( (!isset($_FILES['userfile'])) || (!move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadDir . $ffilename)))
     {
       ...
       echo 'Open a TI Matrix File (83m, 8xm): <input name="userfile" type="file" /> <input type="submit" value="Open">';
       echo '</form>';  
       include "bottom.php";
       die();
     }
  ...
  echo '<li>Matrix size: <font color="DimGray">'.$itemcount.' x '.$itemcount2.'</font></li>';
  echo '</ul>';

  echo '<h2>File Content</h2>';

  echo '<div style="float: left;"><a href="83m-8xm-file-as-text-file.php"><img src="./images/extensions/txt.png"> Save as TXT</a></div>';
  echo '<div style="float: left;">&nbsp;&nbsp;&nbsp;&nbsp;<a href="83m-8xm-file-as-text-file.php?noheader=true"><img src="./images/extensions/txt.png"> Save as TXT without any header information</a></div>';
