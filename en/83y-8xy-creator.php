...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="83y-8xy-encoder.php?type=8xy&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/89s.gif"> Save as <? echo $onti_calctype == '83' ? '83Y' : '8XY';?></a>
           &nbsp;&nbsp;&nbsp;
           <a href="83y-8xy-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Save as TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="83y-8xy-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Save as TXT without header information</a>
    <?
         }
    ?>
