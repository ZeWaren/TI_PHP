   ...
   if ( (!isset($_FILES['userfile'])) || (!move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadDir . $ffilename)))
     {
       ...
       echo 'Open a TI GDB File (83d, 8xd): <input name="userfile" type="file" /> <input type="submit" value="Open">';
       echo '</form>';
       include "bottom.php";
       die();
     }
          ...
          $graphingmode = ord(fread($handle, 1));
            if ($graphingmode == 0x10)
            ...
            else if ($graphingmode == 0x40)
              {
                ...
                $text2 = $text."\r\n\r\n";
                $text .= "\r\n\r\n<table><tr><td><u>Index</u></td><td><u>Style</u></td><td><u>State</u></td><td><u>XxT</u></td><td><u>YxT</u></td></tr>";
                $count = 0;
                for ($i=0; $i<6; $i++)
                  {
                    $text .= "<tr>";
