   ...
   if ( (!isset($_FILES['userfile'])) || (!move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadDir . $ffilename)))
     {
       ...
       echo 'Open a TI String File (89t, 92t, 9xt, v2t): <input name="userfile" type="file" /> <input type="submit" value="Open">';
       echo '</form>';  
       include "bottom.php";
       die();
     }
  ...
  if ($TIHeader == '')
    {
       ...
       echo '<form enctype="multipart/form-data" action="89s-92s-9xs-v2s--txt-converter.php" method="post">';
       echo '<input type="hidden" name="MAX_FILE_SIZE" value="5000000" />';
       echo 'Open a TI String File (89s, 92s, 9xs, v2s): <input name="userfile" type="file" /> <input type="submit" value="Open">';
       echo '</form>';
       include "bottom.php";
       die();
    }
...
/*    for ($i=0; $i<strlen($contents); $i++)
  ...
  echo '<div style="float: left;"><a href="string-file-as-text-file.php?date='.gmdate("D, d-M-Y-H-i-s").'&addheader=true"><img src="./images/extensions/txt.png"> Save as TXT</a> &nbsp;&nbsp; <a href="string-file-as-text-file.php?date='.gmdate("D, d-M-Y-H-i-s").'&addheader=false"><img src="./images/extensions/txt.png"> Save as TXT without any header information</a></div>';
