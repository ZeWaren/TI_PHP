...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="getencodedprogramfile.php?type=83p"><img src="./images/extensions/89z.png"> Save as 83P / 8XP</a>
           &nbsp;&nbsp;&nbsp;
           <a href="getencodedprogramfile.php?type=txt"><img src="./images/extensions/txt.png"> Save as TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="getencodedprogramfile.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Save as TXT without header information</a>
    <?
         }
    ?>
