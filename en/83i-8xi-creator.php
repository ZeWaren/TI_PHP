...
?>
    ...
    ?>
           ...
           <a href="83i-8xi-encoder.php?type=8xi&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/89i.gif"> Save as <? echo $onti_calctype == '83' ? '83I' : '8XI';?></a>
           &nbsp;&nbsp;&nbsp;
           <a href="83i-8xi-encoder.php?type=jpg"><img src="./images/extensions/jpg.png"> Save as JPG</a>
           &nbsp;&nbsp;&nbsp;
           <a href="83i-8xi-encoder.php?type=png"><img src="./images/extensions/png.png"> Save as PNG</a>
           &nbsp;&nbsp;&nbsp;
           <a href="83i-8xi-encoder.php?type=gif"><img src="./images/extensions/gif.png"> Save as GIF</a>
    <?
         }
    ?>
    <?
