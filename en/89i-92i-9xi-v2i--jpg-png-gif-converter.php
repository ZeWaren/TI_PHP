   ...
   if ( (!isset($_FILES['userfile'])) || (!move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadDir . $ffilename)))
     {
       ...
       echo 'Open a TI Image File (89i, 92i, 9xi, v2i): <input name="userfile" type="file" /> <input type="submit" value="Open">';
       echo '</form>';
...
*/
  ...
  echo '<a href="getpicture.php?type=jpeg"><img src="./images/extensions/jpg.png"> Save as JPEG</a> &nbsp;&nbsp;';
  echo '<a href="getpicture.php?type=png"><img src="./images/extensions/png.png"> Save as PNG</a>&nbsp;&nbsp;';
  echo '<a href="getpicture.php?type=gif"><img src="./images/extensions/jpg.png"> Save as GIF</a><br><br>';
