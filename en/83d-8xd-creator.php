...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="83d-8xd-encoder.php?type=8xd&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/89d.gif"> Save as <? echo $onti_calctype == '83' ? '83D' : '8XD';?></a>
           &nbsp;&nbsp;&nbsp;
           <a href="83d-8xd-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Save as TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="83d-8xd-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Save as TXT without header information</a>
    <?
         }
    ?>
    <form action="83d-8xd-creator.php" enctype="multipart/form-data" method="post">
      ...
      <br><br>
        <?
          if ($onti_mode == "function")
            {
              echo '<table><tr><td><u>Name</u></td><td><u>Style</u></td><td><u>State</u></td><td><u>Content</u></td></tr>';
                for ($i = 0; $i<10; $i++)
                  {
                    echo '<tr>';
            ...
            {
              echo '<table><tr><td><u>Index</u></td><td><u>Style</u></td><td><u>State</u></td><td><u>XxT</u></td><td><u>YxT</u></td></tr>';
                for ($i = 1; $i<7; $i++)
                  {
                    echo '<tr>';
                    echo '<td>'.$i.'</td>';
