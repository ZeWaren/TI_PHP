...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="82z-encoder.php?type=82z&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/83t.gif"> Save as 82Z</a>
           &nbsp;&nbsp;&nbsp;
           <a href="82z-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Save as TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="82z-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Save as TXT without header information</a>
    <?
         }
    ?>
