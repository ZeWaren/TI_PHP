...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="89s-92s-9xs-v2s-encoder.php?type=89s"><img src="./images/extensions/89t.png"> Save as 89S / 92S / 9XS / V2S</a>
           &nbsp;&nbsp;&nbsp;
           <a href="89s-92s-9xs-v2s-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Save as TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="89s-92s-9xs-v2s-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Save as TXT without header information</a>
    <?
         }
    ?>
    <form action="89s-92s-9xs-v2s-creator.php" enctype="multipart/form-data" method="post">
      ...
      <br clear="all">
      <h2>File Content</h2>
        Import a text file: <input name="userfile" type="file" /> <input type="submit" value="Import"> <i>Returns will be converted into spaces</i><br><br>
        Content: <input style="width: 600px;" type="text" name="onti_text" value="<? echo htmlentities($onti_text); ?>">
        <br><br>
