...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="83n-8xn-encoder.php?type=8xn&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/83c.gif"> Save as <? echo $onti_calctype == '83' ? '83N' : '8XN';?></a>
           &nbsp;&nbsp;&nbsp;
           <a href="83n-8xn-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Save as TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="83n-8xn-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Save as TXT without header information</a>
    <?
         }
    ?>
