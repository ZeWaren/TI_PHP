...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="82n-encoder.php?type=82n&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/83c.gif"> Save as 82N</a>
           &nbsp;&nbsp;&nbsp;
           <a href="82n-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Save as TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="82n-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Save as TXT without header information</a>
    <?
         }
    ?>
