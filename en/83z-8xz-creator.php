...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="83z-8xz-encoder.php?type=8xz&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/89l.gif"> Save as <? echo $onti_calctype == '83' ? '83Z' : '8XZ';?></a>
           &nbsp;&nbsp;&nbsp;
           <a href="83z-8xz-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Save as TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="83z-8xz-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Save as TXT without header information</a>
    <?
         }
    ?>
