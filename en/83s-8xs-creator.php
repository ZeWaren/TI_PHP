...
//       echo $filename;
  ...
  ?>
    ...
    ?>
           ...
           <a href="83s-8xs-encoder.php?type=8xs&date=<? echo gmdate("d-M-Y-H:i:s")?>"><img src="./images/extensions/89s.gif"> Save as <? echo $onti_calctype == '83' ? '83S' : '8XS';?></a>
           &nbsp;&nbsp;&nbsp;
           <a href="83s-8xs-encoder.php?type=txt"><img src="./images/extensions/txt.png"> Save as TXT</a>
           &nbsp;&nbsp;&nbsp;
           <a href="83s-8xs-encoder.php?type=txtnoheader"><img src="./images/extensions/txt.png"> Save as TXT without header information</a>
    <?
         }
    ?>
    <form action="83s-8xs-creator.php" enctype="multipart/form-data" method="post">
      ...
      <h2>File Content</h2>
        Text: <input style="width: 400px;" type="text" name="onti_text" value="<? echo $onti_text; ?>">
      <br><br>
